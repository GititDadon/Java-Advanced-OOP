		...
		if(e.getSource()==done)
			...
			if(type!=null)
			{
				...
				case "Lion":
				{
					...
					animal=new Lion(siz2,color,this.zooPanel);
				...
				case "Bear":
				{
					...
					animal=new Bear(siz2,color,zooPanel);
					this.zooPanel.setAnimalList(animal);
				...
				case "Giraffe":
				{
					animal=new Giraffe(siz2,color,zooPanel);
					this.zooPanel.setAnimalList(animal);
				...
				case "Elephant":
				{
					animal=new Elephant(siz2,color,zooPanel);
					this.zooPanel.setAnimalList(animal);
				...
				case "Turtle":
				{
					animal=new Turtle(siz2,color,zooPanel);
					this.zooPanel.setAnimalList(animal);
